...
/**
 * @template-extends \Ibexa\Bundle\AdminUi\ValueResolver\AbstractValueResolver<\Ibexa\Contracts\Core\Repository\Values\User\PolicyDraft>
 */
final class PolicyDraftValueResolver extends AbstractValueResolver
{
