...
const layout = [
    ...
    path.resolve(__dirname, '../../../../../design-system-twig/src/bundle/Resources/public/ts/init_components.ts'),
...
module.exports = (Encore) => {
    Encore.addEntry('ibexa-admin-ui-layout-js', layout)
        ...
        .addEntry('ibexa-admin-ui-login-js', [
            ...
            path.resolve(__dirname, '../public/js/scripts/admin.account.form.validation.js'),
        ])
