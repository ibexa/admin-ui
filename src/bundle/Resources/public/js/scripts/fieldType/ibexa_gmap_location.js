(function (global, doc, ibexa, Leaflet, Translator) {
    const SELECTOR_FIELD = '.ibexa-field-edit--ibexa_gmap_location';
        ...
        validateField(config, event) {
            ...
            if (validationResult.isError) {
                const errorMessage = Translator.trans(
                    /* @Desc("Area above needs correction") */ 'ibexa_maplocation.create.message.error',
                    {},
    ...
    doc.querySelectorAll(SELECTOR_FIELD).forEach((field) => {
        ...
        const searchBtn = field.querySelector('.ids-button--search-by-address');
