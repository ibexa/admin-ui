    ...
    class IbexaImageAssetPreviewField extends ibexa.BasePreviewField {
        ...
        onAssetCreateSuccess(response) {
            ...
            showSuccessNotification(
                Translator.trans(
                    /* @Desc("The image has been published and can now be reused") */ 'ibexa_image_asset.create.message.success',
                    {},
        ...
        onAssetCreateFailure(error) {
            const message = Translator.trans(
                /* @Desc("Error while creating Image Asset: %error%") */ 'ibexa_image_asset.create.message.error',
                { error: error.message },
                'ibexa_fieldtypes_edit',
            );
        ...
        loadAsset(response) {
            ...
            if (imageField.fieldValue === null) {
                showErrorNotification(
                    Translator.trans(
                        /* @Desc("The chosen asset has no image data available.") */ 'ibexa_image_asset.empty_data.message.error',
                        {},
                        'ibexa_fieldtypes_edit',
                    ),
                );
