...
export default class TableViewItemComponent extends PureComponent {
    ...
    editItem(languageCode) {
        //TO DO: check if id is location or conten id
        //Probably content_id
        const { contentId, currentVersionNo } = this.item;
    ...
    renderNameCell() {
        ...
        const contentName = this.item.name;
        ...
        const contentId =  1; // TO DO missing in response
        const linkAttrs = {
    ...
    renderModifiedCell() {
        const formatedModificationDate = formatShortDateTime(new Date(this.item.modificationDate * 1000));

        return <div className="c-table-view-item__text-wrapper">{formatedModificationDate}</div>;
    }

    renderPublishedCell() {
        const formatedPublishedDate = formatShortDateTime(new Date(this.item.publishedDate * 1000));

        return <div className="c-table-view-item__text-wrapper">{formatedPublishedDate}</div>;
    }
        ...
        return (
            <div className="c-table-view-item__text-wrapper">
                <UserName
                    ...
                    thumbnail={lastContributor.thumbnail}
    ...
    renderSectionCell() {
        return <div className="c-table-view-item__text-wrapper">{this.item.sectionName}</div>;
    }
    ...
    renderObjectIdCell() {
        return <div className="c-table-view-item__text-wrapper">TO DO: content_id</div>;
    }

    renderObjectRemoteIdCell() {
        return <div className="c-table-view-item__text-wrapper">{this.item.contentRemoteId}</div>;
    }
