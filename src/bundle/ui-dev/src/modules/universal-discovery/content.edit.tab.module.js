...
const ContentEditTabModule = () => {
    ...
    const handleIframeLoad = () => {
        ...
        const iframeConfirmBtn = iframeBody.querySelector('.ibexa-context-menu .ids-btn--confirm');
        const iframeCancelBtn = iframeBody.querySelector('.ibexa-context-menu .ids-btn--cancel');
