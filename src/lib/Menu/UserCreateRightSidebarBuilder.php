 ...
 */
final class UserCreateRightSidebarBuilder extends AbstractBuilder implements TranslationContainerInterface
{
    public const string ITEM__CREATE = 'user_create__sidebar_right__create';
    public const string ITEM__CANCEL = 'user_create__sidebar_right__cancel';
