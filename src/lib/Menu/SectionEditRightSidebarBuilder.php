...
final class SectionEditRightSidebarBuilder extends AbstractBuilder implements TranslationContainerInterface
{
    public const string ITEM__SAVE_AND_CLOSE = 'section_edit__sidebar_right__save_and_close';
    public const string ITEM__CANCEL = 'section_edit__sidebar_right__cancel';
