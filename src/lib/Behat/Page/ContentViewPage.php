...
class ContentViewPage extends Page
{
    ...
    protected function specifyLocators(): array
    {
        return [
            ...
            new VisibleCSSLocator('addTranslationButton', '#ibexa-tab-location-view-translations .ibexa-table-header__actions .ids-button--add-translation, [data-bs-target="#add-translation-modal"]'),
            ...
            new VisibleCSSLocator('cancelScheduleButton', '.ids-button--schedule-hide-cancel'),
        ];
    }
