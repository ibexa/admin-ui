...
#[\PHPUnit\Framework\Attributes\CoversClass(\Ibexa\AdminUi\Form\Processor\ContentType\ContentTypeFormProcessor::class)]
final class ContentTypeFormProcessorTest extends TestCase
{
    ...
    public function testProcessDefaultAction(): void
    {
        ...
        $event = new FormActionEvent($this->createStub(FormInterface::class), $contentTypeData, 'fooAction');
    ...
    public function testRemoveFieldDefinition(): void
    {
        ...
        $compoundFormConfig->method('getDataMapper')->willReturn($this->createStub(DataMapperInterface::class));
