...
final class GetUsersWithPermissionInfoToContentItemTest extends WebTestCase
{
    ...
    public function provideDataForTestGetUsersWithPermissionsEndpoint(): iterable
    {
        yield 'Check content-read for content item 41' => [
            ...
            self::FUNCTION_READ,
            [],
            '{"access":[{"name":"Administrator User","email":"admin@link.invalid"},{"name":"John Doe","email":"john@link.invalid"},{"name":"Josh Bar","email":"joshua@link.invalid"}],"no_access":[{"name":"Anonymous User","email":"anonymous@link.invalid"}]}',
        ];
        ...
        yield 'Check content-read for location 43 and phrase=anony' => [
            ...
            '{"access":[],"no_access":[{"name":"Anonymous User","email":"anonymous@link.invalid"}]}',
        ];
